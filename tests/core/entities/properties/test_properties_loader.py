...
from py_spring.core.entities.properties.properties_loader import _PropertiesLoader, InvalidPropertiesKeyError
...
class TestPropertiesLoader:
    ...
    def test_load_properties_from_valid_json_file(self, mocker: MockerFixture, mock_properties_classes: list[type[Properties]]):
        
        mocker.patch("builtins.open", mocker.mock_open(read_data='{"mock_properties": {"attr": "value"}}'))
    ...
    def test_load_properties_from_valid_yaml_file(self, mocker: MockerFixture, mock_properties_classes: list[type[Properties]]):
        mocker.patch("builtins.open", mocker.mock_open(read_data='mock_properties:\n  attr: value'))
    ...
    def test_handle_valid_file_paths_with_correct_extensions(self, mocker: MockerFixture):
    ...
    def test_load_properties_from_unsupported_extension(self, mocker: MockerFixture):
        ...
        with pytest.raises(ValueError, match="Unsupported file extension"):
            ...
            loader._load_properties_dict_from_file_content(loader.file_extension, loader.properties_file_content)
            
            
    def test_load_properties_with_invalid_keys(self, mocker: MockerFixture):
        mocker.patch("builtins.open", mocker.mock_open(read_data='{"invalid_key": {"attr": "value"}}'))
