...
class TestBeanView:
    ...
    def test_bean_view(self, test_bean: TestBean) -> BeanView:
        bean_view = BeanView(bean_creation_func=lambda: test_bean, bean_name="TestBean", bean= test_bean)
    ...
    def test_exclude_bean_creation_func_from_serialization(self, test_bean_view: BeanView):
    ...
    def test_none_bean(self):
        bean_view = BeanView(bean_creation_func=lambda: None, bean_name="Component", bean=None)
        assert not bean_view.is_valid_bean()
        
    def test_arbitrary_types_for_bean_attribute(self):
        arbitrary_object = object()
        bean_view = BeanView(bean_creation_func=lambda: arbitrary_object, bean_name="object", bean=arbitrary_object)
    ...
    def test_internal_consistency_on_update(self):
        ...
        bean_view = BeanView(bean_creation_func=lambda: initial_bean, bean_name="Component", bean=initial_bean)
